...
class CannabisRecommendationBot:
    ...
    def get_json_output_prompt(self) -> str:
        ...
        {{
            "response": {{
                ...
                "options": ["List", "of", "relevant", "options"] if applicable,
    ...
    def get_thought_generation_prompt(self) -> str:
        ...
        For each question, provide a list of relevant options for the user to choose from.
        """
    ...
    def update_session_data(self, tot_output: Dict[str, Any]):
        ...
        self.session_data["rag_analysis"]["relationships"] = tot_output.get("relationships", {})
