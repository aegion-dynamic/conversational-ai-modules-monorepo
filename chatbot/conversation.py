...
The Goal for the output: The goal of this output is to answer the following question from a someone looking to learn about medical cannabis. 
...
Other Notes: in the output, avoid self-referencing to the speaker. Simply jump into education rather than referencing the speaker. If you recieve any links in the input, please highlight them in the output."""
         ),
    ]
