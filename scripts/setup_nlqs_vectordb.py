...
VectorDBDriver.purge_nlqs_vectordb(
...
VectorDBDriver.initialize_nlqs_vectordb(
    chroma_config=chroma_config
)
...
VectorDBDriver.populate_nlqs_vectordb(chroma_config, column_info_df)
...
VectorDBDriver.populate_nlqs_vectordb(chroma_config, dataset_info=dataset_info_df)
