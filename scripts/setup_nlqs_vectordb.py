...
column_info_df = pd.read_csv("./test_data/column_metadata.csv")
VectorDBDriver.populate_nlqs_vectordb(ChromaDBConfig(), column_info_df)

#TODO: Populate the NLQS VectorDB dataset collection
dataset_info_df = pd.read_csv("./test_data/product_descriptions.csv")
VectorDBDriver.populate_nlqs_vectordb(ChromaDBConfig(), dataset_info=dataset_info_df)
