...
class CannabisRecommendationSystem:
    ...
    def get_llm_response(self, user_input: str, state_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        4. If in the RECOMMENDATION state:
           a. Use the knowledge base to ask relevant questions about product types, effects, onset times, durations, use times, and strengths.
           b. Avoid medical jargon and use simple, easy-to-understand language questions only.
           c. Provide a complete recommendation with usage guidelines and precautions based on the knowledge base.
           d. Ensure questions and options are directly related to items in the knowledge base.
        5. If in the CONCLUSION state, summarize the recommendation and provide next steps without asking follow-up questions.
        6. For other states, if necessary, ask a single, focused follow-up question to gather missing information.
        7. Provide 2-3 sample options for the user to choose from in their response, except in the CONCLUSION state. These options should be based on the knowledge base when applicable.
